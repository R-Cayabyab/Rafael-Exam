...
WebUI.click(findTestObject('Object Repository/Page_Amazon.com Online Shopping for/a_Hello Sign in  Account  List'))

WebUI.click(findTestObject('Object Repository/Page_Amazon.com Online Shopping for/span_Sign in (1)'))
